...
hoSumSquares = higherOrderSequenceApplication (+) sq
...
hoSumInts = higherOrderSequenceApplication (+) id
...
--  - A start value, a :: Int
--  - A end value, b :: Int
--  - A function to apply to each value, f :: Int -> Int
--  - A function to apply between each value, op :: Int -> Int -> Int
--  - A value to return in the base case when a > b, z :: Int
higherOrderSequenceApplication :: (Int -> Int -> Int) -> (Int -> Int) -> Int -> Int -> Int -> Int
higherOrderSequenceApplication op f e a b 
    | a > b = e
    | otherwise = (f a) `op` higherOrderSequenceApplication op f e (a+1) b
